...
bool isPermutationOfPallindrome1( const std::string & str )
{
    ...
    /*
     * I will check here that letter frequencies are all even or all even except one odd.
     */
...
/*
 * Approach 2:
 * Lets optimize above function instead of taking another pass let us do it
...
/*
 * Approach 3
 * lets represent each char with a bit in a bitvector
